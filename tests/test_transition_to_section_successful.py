...
class TestTransitionToSection:
    def test_transition_to_section_buns_successful(self, driver):
    ...
    def test_transition_to_section_sauces_successful(self, driver):
        driver.get("https://stellarburgers.nomoreparties.site/")
        WebDriverWait(driver, 10).until(EC.element_to_be_clickable(Locators.SAUCES_TAB)).click()
    ...
    def test_transition_to_section_filling_successful(self, driver):
        driver.get("https://stellarburgers.nomoreparties.site/")
